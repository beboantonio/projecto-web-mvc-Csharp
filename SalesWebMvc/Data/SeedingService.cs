...
{
    // Class que possui o método responsável por povoar o sistema de banco de dados
    public class SeedingService
    {
        ...
        // Método responsável por popular o sistema de banco de dados
        public void Seed() 
        {
            // Verificando se já existe algum dado (registro) nestas tabelas no meu banco de dados
            ...
            // criando os objectos dos "Department"
            Department d1 = new Department(1, "Computers");
            Department d2 = new Department(2, "Electronics");
            Department d3 = new Department(3, "Fashion");
            Department d4 = new Department(4, "Books");
            Department d5 = new Department { Id = 5, Nome = "Cell-Phones"};

            // criando os objectos dos "Saller" e atribuindo-lhes os seus respectivos "Department"
            ...
            // criando os objectos dos "SalesRecord" e atribuindo-lhes os seus respectivos "SalesStatus", a que "Saller" elas pertencem
            ...
            /*
               Depois de criar o objectos, vamos adiciona-los nas suas respectivas tabelas no BD usando "Entity Framework"
                
                Para tal vamos usar o "AddRange()", método que permite adicionar vários objectos de uma só vez
             */
            // Adicionando os objectos da tabela "Department" no BD
            _context.Department.AddRange(d1, d2, d3, d4);

            // Adicionando os objectos da tabela "Saller" no BD
            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6);

            // Adicionando os objectos da tabela "SalesRecord" no BD
